...
## Important
- Debug and Info: `(ctx, message, ...Annotation)` — NO error parameter
- Warn and Error: `(ctx, error, message, ...Annotation)` — error is second parameter
- Build annotations with `axio.Field(key, value)`
